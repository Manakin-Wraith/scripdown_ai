...
2. **AI API Keys**
   - `GEMINI_API_KEY`: `AIzaSyDd6kMOnW6lrbutTK8O34WFgnENm3NOjCs` (exposed)

3. **Email Service (Resend)**
   - `RESEND_API_KEY`: `re_gtgcoYQP_HTJe9TWSL72aB7jkfjpWZQN1` (exposed)
...
2. Delete key: `re_gtgcoYQP_HTJe9TWSL72aB7jkfjpWZQN1`
...
2. Delete key: `AIzaSyDd6kMOnW6lrbutTK8O34WFgnENm3NOjCs`
3. Create new API key
