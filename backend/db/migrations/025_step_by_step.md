# Email Campaigns Migration - Step by Step

Run these SQL statements **one at a time** in Supabase Dashboard to identify which step is failing.
...
## Step 4: Create email_campaign_recipients table
...
## Step 5: Create email_campaign_clicks table
...
('Trial Expiring Soon', 'Your ScripDown AI trial expires in {{days_left}} days', '<html><body><h1>Hi {{user_name}},</h1><p>Your trial expires in <strong>{{days_left}} days</strong>.</p></body></html>', 'Hi {{user_name}}, Your trial expires in {{days_left}} days.', 'marketing', '["user_name", "days_left", "upgrade_url"]'::jsonb),
('Welcome New User', 'Welcome to SlateOne!', '<html><body><h1>Welcome {{user_name}}!</h1></body></html>', 'Welcome {{user_name}}!', 'transactional', '["user_name", "app_url"]'::jsonb),
('Inactive User Re-engagement', 'We miss you at SlateOne', '<html><body><h1>Hi {{user_name}},</h1></body></html>', 'Hi {{user_name}}', 'marketing', '["user_name", "days_inactive", "app_url"]'::jsonb),
('Feature Announcement', 'New Feature: {{feature_name}}', '<html><body><h1>Hi {{user_name}},</h1></body></html>', 'Hi {{user_name}}', 'notification', '["user_name", "feature_name", "feature_description", "feature_url"]'::jsonb)
...
SELECT COUNT(*) FROM email_campaign_clicks;
```
