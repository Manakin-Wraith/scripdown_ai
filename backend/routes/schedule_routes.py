    ...
    try:
        ...
        for day in days:
            scenes_result = supabase.table('shooting_day_scenes') \
                .select('*, scenes(id, scene_number, setting, location_canonical, int_ext, time_of_day, story_day, characters, page_length_eighths, scene_text, page_start, page_end, is_omitted)') \
