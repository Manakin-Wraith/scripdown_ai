"""
Data models for screenplay elements using Pydantic v2 for validation.

Vendored from ScreenPy with the following changes:
- Pydantic v2 syntax (model_config, model_dump, ConfigDict)
- Removed VerbSense and ActionInstance (VSD module, not needed)
"""
...
class Segment(BaseModel):
    ...
    def is_master_segment(self) -> bool:
        ...
        return self.heading is not None and self.heading.is_master
